...
export const AnthemPage = () => {
  ...
  return (
    <div className="flex w-full h-full my-6 justify-center items-center overflow-hidden ">
      <div
        className="flex flex-col w-full xl:w-5/6 h-full px-2 md:mx-6 md:p-4 md:pb-8 items-center bg-backgroundTransparent rounded-xl"
      ...
      >
        ...
        {!videoBlob ? (
          ...
          <div className="flex justify-center items-center 2xl:p-20 h-full w-full">
            {/* eslint-disable-next-line jsx-a11y/media-has-caption */}
            <video key="history-video" className="w-fit rounded-lg" controls>
              <source
